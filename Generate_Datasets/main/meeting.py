...
# General Configs
parser.add_argument("--nr_scenes", default=40, type=int, help="Specify number of scenes")
...
parser.add_argument("--phase", default="meeting", type=str, help="Specify for which phase data should be created")
...
parser.add_argument("--nr_agents", default=2, type=int, help="Specify number of agents")
...
if args.run_list:
    ...
    for V0 in V0_list:
        for sigma in sigma_list:
            ...
            args.nr_scenes = 1800
            # Create Scene
            PedPedScene = Scenarios.PedPedScene(args.V0, args.sigma, args.delta_t, args.twophi, args.c, args.v_max, args.v_min, args.dataset, args.phase, tau=args.tau, a=args.a, b=args.b)

            initial_agent_states = []
            states_of_Scene = PedPedScene.get_scene(args.nr_agents, args.nr_scenes, initial_agent_states, threshold=args.threshold, scenario="meeting")
            ...
            PedPedScene = Scenarios.PedPedScene(args.V0, args.sigma, args.delta_t, args.twophi, args.c, args.v_max,
                                                args.v_min, args.dataset, args.phase, tau=args.tau, a=args.a, b=args.b)

            initial_agent_states = []
            states_of_Scene = PedPedScene.get_scene(args.nr_agents, args.nr_scenes, initial_agent_states,
                                                    threshold=args.threshold, scenario="meeting")
    ...
    PedPedScene = Scenarios.PedPedScene(args.V0, args.sigma, args.delta_t, args.twophi, args.c, args.v_max, args.v_min,
                                        args.dataset, args.phase, tau=args.tau, a=args.a, b=args.b)
