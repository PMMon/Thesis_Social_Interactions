...
# General Configs
parser.add_argument("--nr_scenes", default=80, type=int, help="Specify number of scenes")
...
parser.add_argument("--dataset", default="square", type=str, help="Specify which scene should be animated")
...
parser.add_argument("--seq_len", default=20, type=int, help="Specify length of sequences")
...
if args.run_list:
    ...
    #sigma_list = [0.2171, 0.4343, 0.8686, 1.303, 1.7371, 2.1715, 2.6058, 3.04]
    #V0_list = [0,1,2,4,6]
    sigma_list = [1.303]
    V0_list = [2]
    ...
    for V0 in V0_list:
        for sigma in sigma_list:
            ...
            args.nr_scenes = 1800
            # Create Scene
            PedPedScene = Scenarios.PedPedScene_constantly_present(args.V0, args.sigma, args.delta_t, args.twophi, args.c, args.v_max, args.v_min, args.dataset, args.phase, tau=args.tau, a=args.a, b=args.b, seq_len=args.seq_len)
            ...
            args.nr_scenes = 1800
            # Create Scene
            PedPedScene = Scenarios.PedPedScene_constantly_present(args.V0, args.sigma, args.delta_t, args.twophi, args.c, args.v_max,
                                                args.v_min, args.dataset, args.phase, tau=args.tau, a=args.a, b=args.b, seq_len=args.seq_len)
    ...
    PedPedScene = Scenarios.PedPedScene_constantly_present(args.V0, args.sigma, args.delta_t, args.twophi, args.c, args.v_max, args.v_min,
                                        args.dataset, args.phase, tau=args.tau, a=args.a, b=args.b, seq_len=args.seq_len)
