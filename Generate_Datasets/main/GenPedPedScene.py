...
parser.add_argument("--scenario", default="", type=str, help="Specify name of scenario that should be animated. Choose either zara1, zara2, univ, hotel, eth, square or rectangle.")
